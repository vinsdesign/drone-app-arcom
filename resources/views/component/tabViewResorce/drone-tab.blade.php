...
//flight
$flights = App\Models\Fligh::where('teams_id', $teams)->where('drones_id', $id)->get();
$count = $flights->count('id');
$flights = App\Models\Fligh::where('teams_id', $teams)->where('drones_id', $id)->paginate(10);
                                ...
                                <div class="flex flex-nowrap space-x-4 min-w-max flex-col">
                                    <div class="flex flex-nowrap space-x-4 min-w-max flex-1">
                                        ...
                                        <div class="flex-1 min-w-[300px] mb-2 border-r border-gray-300 pr-4">
                                            ...
                                            @endif
                                            <p class="text-sm text-gray-700 dark:text-gray-400">
                                                {{ $item->drone->brand ?? null }}/{{ $item->drone->model ?? null }}</p>
                                        </div>
