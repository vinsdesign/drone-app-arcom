    ...
    <div class="container mx-auto p-5">
        ...
        <div class="content">
            ...
            <div id="content0" class="tab-content active">
                ...
                <div class="fixed active-modal inset-0 flex justify-center z-50" style="max-height: 80%">
                    <div
                        ...
                        {{-- error massages --}}
                        <div id="bodyErrorMassagesDflight" style="display: none;"
                        ...
                        <form id="documentFormFlight" enctype="multipart/form-data">
                            @csrf
                            <input id="ownerFlight" type="hidden" name="teams_idFlight"
                                value="{{ auth()->user()->id }}">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input id="nameFlight" type="text" name="nameFlight" maxlength="255"
                                ...
                                <div>
                                    ...
                                    <input id="expiredDateFlight" type="date" name="expiredDateFlight"
                                        class="w-full mt-1 p-2 border dark:bg-gray-900 dark:border-gray-700 dark:text-gray-300 rounded-md focus:ring focus:ring-blue-500">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input id="refnumberFlight" type="text" name="refnumberFlight"
                                        class="w-full mt-1 p-2 border dark:bg-gray-900 dark:border-gray-700 dark:text-gray-300 rounded-md focus:ring focus:ring-blue-500">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input id="externalLinkFlight" type="text" name="externalLinkFlight"
                                        class="w-full mt-1 p-2 border dark:bg-gray-900 dark:border-gray-700 dark:text-gray-300 rounded-md focus:ring focus:ring-blue-500">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input id="dockFlight" type="file" name="dockFlight"
                                    class="w-full mt-1 p-2 border dark:bg-gray-900 dark:border-gray-700 dark:text-gray-300 rounded-md focus:ring focus:ring-blue-500">
                            </div>
                            ...
                            <div>
                                ...
                                <textarea id="descriptionFlight" name="descriptionFlight" maxlength="255"
                            ...
                            <div class="flex justify-end mt-4">
                                <button id="triggerButtonFlight" type="button" class="button"
            ...
            <div id="content1" class="tab-content">
                ...
                <!-- Modal -->
                <div class="fixed active-modal flight-create inset-0 flex justify-center z-50"
                    style="max-height: 80%">
                    <div
                        class="relative space-y-6 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg max-w-4xl w-full max-h-[80%] overflow-y-auto mx-4 md:mx-auto">
                        <!-- Tombol Close -->
                        ...
                        <hr class="border-t border-gray-300 dark:border-gray-600 w-24 mx-auto">
                        {{-- error massages --}}
                        <div id="bodyErrorMassagesDproject" style="display: none;"
                            class="rounded-md bg-red-50 p-4 shadow dark:bg-red-800" role="alert">
                            <div class="flex items-start">
                                <div class="flex-shrink-0">
                                    <!-- Icon Error -->
                        ...
                        <form id="documentForm" enctype="multipart/form-data">
                            ...
                            <input id="owner" type="hidden" name="teams_id"
                                value="{{ auth()->user()->id }}">
                            <input id="project" type="hidden" name="recordID" value="{{ $projectID }}">
                ...
                <div class="mb-2">
                    ...
                    <div class="mt-4 flex justify-end mb-4">
                        <button type="button" onclick="openModalFlight()"
                            class="px-4 py-2 bg-gray-700 text-white font-semibold rounded-lg 
                    hover:bg-gray-600 dark:hover:bg-gray-400 focus:outline-none focus:ring-2 
                            ...
                            <div
                                ...
                                <div class="flex flex-nowrap space-x-4 min-w-max flex-col">
                                    <div class="flex flex-nowrap space-x-4 min-w-max flex-1">
                                        <div class="flex-1 min-w-[300px] mb-2 border-r border-gray-300 pr-4">
                                            <p class="text-l text-gray-800 dark:text-gray-200 font-semibold truncate">
                                                {!! TranslationHelper::translateIfNeeded('Date : ') !!}<span
                                                    class="text-sm text-gray-500 dark:text-gray-150 font-semibold truncate">{{ $item->incident_date }}</span>
                                            </p>
                                            <a
                                        ...
                                        <div class="flex-1 min-w-[300px] mb-2 border-r border-gray-300 pr-4">
                                            <p class="text-l text-gray-800 dark:text-gray-200 font-semibold">
                                                {!! TranslationHelper::translateIfNeeded('Personnel Involved : ') !!}</p>
                                        ...
                                        <div
                                            class="flex justify-end items-center mb-2 min-w-[150px] border-gray-300 pr-2">
                                    ...
                                    <div class="px-2 mb-4">
                                        <div
                                            ...
                                            <div class="flex-1 min-w-[180px]">
                                                <p class="text-sm text-gray-700 dark:text-gray-400">
                                                    <strong>{!! TranslationHelper::translateIfNeeded('Notes:') !!} </strong>{{ $item->description }}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div id="content3" class="tab-content">
                ...
                <div class="fixed active-modal media-create inset-0 flex justify-center z-50" style="max-height: 80%">
                    <div
                        ...
                        <hr class="border-t border-gray-300 dark:border-gray-600 w-24 mx-auto">
                        {{-- error massages --}}
                        <div id="bodyErrorMassagesMCreate" style="display: none;"
                            class="rounded-md bg-red-50 p-4 shadow dark:bg-red-800" role="alert">
                            <div class="flex items-start">
                                <div class="flex-shrink-0">
                                    <!-- Icon Error -->
                        ...
                        <form id="documentForm" enctype="multipart/form-data">
                            @csrf
                            <input id="ownerMedia" type="hidden" name="teams_id"
                                value="{{ auth()->user()->id }}">
                            <input id="mediaFlightID" type="hidden" name="mediaFlightID"
                                value="{{ $id }}">

                            <!-- Name Input -->
                            <div>
                                <label class="block text-gray-700 dark:text-gray-300">{!! TranslationHelper::translateIfNeeded('Media Title') !!}</label>
                                <input id="nameMedia" type="text" name="nameMedia" maxlength="255"
                                    class="w-full mt-1 p-2 border dark:bg-gray-900 dark:border-gray-700 dark:text-gray-300 rounded-md focus:ring focus:ring-blue-500">
                            </div>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label
                                        class="block text-gray-700 dark:text-gray-300">{!! TranslationHelper::translateIfNeeded('Media URL') !!}</label>
                                    <input id="urlMedia" type="text" name="urlMedia"
                                        class="w-full mt-1 p-2 border dark:bg-gray-900 dark:border-gray-700 dark:text-gray-300 rounded-md focus:ring focus:ring-blue-500">
                                </div>
                                ...
                                <div>
                                    <label
                                        class="block text-gray-700 dark:text-gray-300">{!! TranslationHelper::translateIfNeeded('Type Url') !!}</label>
                                    <select id="mediaType" type="text" name="mediaType"
                                        class="w-full mt-1 p-2 border dark:bg-gray-900 dark:border-gray-700 dark:text-gray-300 rounded-md focus:ring focus:ring-blue-500">
                            ...
                            <div>
                                <label class="block text-gray-700 dark:text-gray-300">{!! TranslationHelper::translateIfNeeded('Notes') !!}</label>
                                <textarea id="descriptionMedia" name="descriptionMedia" maxlength="255"
                                    class="w-full mt-1 p-2 border dark:bg-gray-900 dark:border-gray-700 dark:text-gray-300 rounded-md focus:ring focus:ring-blue-500"></textarea>
                            </div>

                            <!-- Submit Button -->
                            <div class="flex justify-end mt-4">
                                <button id="triggerButtonMedia" type="button" class="button"
                                    style="font-size: 16px; background-color: #4A5568; color: white; font-weight: bold; padding: 8px 16px; border-radius: 4px; border: none; cursor: pointer;">
                                    <span class="button__text">{!! TranslationHelper::translateIfNeeded('Submit') !!}</span>
                                </button>
                            </div>
                ...
                <!-- Modal  Edit-->
                @if ($media != null)
                    <div class="fixed active-modal media-edit inset-0 flex justify-center z-50"
                        style="max-height: 80%">
                        <div
                            class="relative space-y-6 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg max-w-4xl w-full max-h-[80%] overflow-y-auto mx-4 md:mx-auto">
                            <!-- Tombol Close -->
                            ...
                            <hr class="border-t border-gray-300 dark:border-gray-600 w-24 mx-auto">
                            {{-- error massages --}}
                            <div id="bodyErrorMassagesMEdit" style="display: none;"
                                class="rounded-md bg-red-50 p-4 shadow dark:bg-red-800" role="alert">
                                <div class="flex items-start">
                                    <div class="flex-shrink-0">
                                        <!-- Icon Error -->
                            ...
                            <form id="documentFormEdit" enctype="multipart/form-data">
                                @csrf
                                <input id="idMediaEdit" type="hidden" name="IdMediaEdit"
                                    value="{{ $media->id }}">
                                <input id="ownerMediaEdit" type="hidden" name="teams_id"
                                    value="{{ $media->owner_id }}">
                                <input id="mediaFlightIDEdit" type="hidden" name="mediaFlightID"
                                    value="{{ $media->fligh_id }}">

                                <!-- Name Input -->
                                <div>
                                    <label
                                        class="block text-gray-700 dark:text-gray-300">{!! TranslationHelper::translateIfNeeded('Media Title') !!}</label>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        <label
                                            class="block text-gray-700 dark:text-gray-300">{!! TranslationHelper::translateIfNeeded('Type Url') !!}</label>
                                        <select id="mediaTypeEdit" type="text" name="mediaType"
                                            class="w-full mt-1 p-2 border dark:bg-gray-900 dark:border-gray-700 dark:text-gray-300 rounded-md focus:ring focus:ring-blue-500">
                                            @if ($media->type != null)
                                                <option value="{{ $media->type }}" selected>-- {{ $media->type }}
                                                    Url --</option>
                                            @endif
                                ...
                                <!-- Submit Button -->
                                <div class="flex justify-end mt-4">
                                    <button id="triggerButtonMediaEdit" type="button" class="button"
                                        style="font-size: 16px; background-color: #4A5568; color: white; font-weight: bold; padding: 8px 16px; border-radius: 4px; border: none; cursor: pointer;">
                ...
                <div class="mb-2">
                    ...
                    <div class="mt-4 flex justify-end mb-4">
                        <button type="button" onclick="openModalMedia()"
                            class="px-4 py-2 bg-gray-700 text-white font-semibold rounded-lg 
                hover:bg-gray-600 dark:hover:bg-gray-400 focus:outline-none focus:ring-2 
                        ...
                        @foreach ($flighmedia as $item)
                            <div
                                ...
                                <div class="flex flex-nowrap space-x-4 min-w-max">
                                    <div
                                        class="flex-1 min-w-[150px] mb-2 border-r border-gray-300 pr-2 overflow-hidden">
                                        <p class="text-l text-gray-800 dark:text-gray-200 font-semibold truncate">
                                            {!! TranslationHelper::translateIfNeeded('Title : ') !!}</p>
                                        <p class="text-sm text-gray-500 dark:text-gray-150 font-semibold truncate">
                                            {{ $item->title }}</p>
                                        <p class="text-sm text-gray-500 dark:text-gray-150 font-semibold truncate">
                                            {{ $item->type }}</p>
                                    ...
                                    <div class="flex-1 min-w-[150px] mb-2 border-r border-gray-300 pr-2">
                                        <p class="text-l text-gray-800 dark:text-gray-200 font-semibold">
                                            {!! TranslationHelper::translateIfNeeded('Notes:') !!}</p>
                                        <p class="text-sm text-gray-500 dark:text-gray-150 font-semibold truncate">
                                            {{ $item->description }}</p>
                                        </p>
                                    </div>
                                    ...
                                    <!-- Column Modified-->
                                    <div class="flex justify-end items-center mb-2 min-w-[150px] border-gray-300 pr-2">
                                        <button id="ViewButton-{{ $item->id }}" type="button"
                                            class="px-4 py-2 bg-gray-700 text-white font-semibold rounded-lg 
                                    ...
                                    <div class="flex justify-end items-center mb-2 min-w-[150px] border-gray-300 pr-2">
                                        ...
                                        <button id="valueButton-{{ $item->id }}" type="button"
                                            class="px-4 py-2 bg-gray-700 text-white font-semibold rounded-lg 
                                hover:bg-gray-600 dark:hover:bg-gray-400 focus:outline-none focus:ring-2 
                                focus:ring-gray-500 dark:focus:ring-gray-300"
                                            value="{{ $item->id }}"
                                            onclick="openModalMediaEdit({{ $item->id }})">
                                            {!! TranslationHelper::translateIfNeeded('Edit') !!}
                                        </button>
                                    </div>
    ...
    $(document).ready(function() {
        $('#triggerButtonFlight').click(function() {
            ...
            formDataFlight.append('flight', $('#flight').val());
          	formDataFlight.append('flight_id', $('#flight_id').val());
           ...
           let test = $('#flight_id').val().trim() || null;
