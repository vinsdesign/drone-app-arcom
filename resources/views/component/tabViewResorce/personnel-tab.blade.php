...
//FlightIncident
$Incident = App\Models\Incident::whereHas('users', function ($query) use ($id) {
    ...
    <div class="container mx-auto p-5">
        ...
        <div
            ...
            <div class="flex flex-wrap gap-1 justify-between">
                <button id="tab0"
                    class="tab-button active text-white bg-gray-800 hover:bg-gray-700 px-4 py-2 rounded text-sm sm:text-base">
                    {!! TranslationHelper::translateIfNeeded('Users Document') !!}
                </button>
                <button id="tab1"
                    class="tab-button text-white bg-gray-800 hover:bg-gray-700 px-4 py-2 rounded text-sm sm:text-base">
                                    ...
                                    <div class="flex flex-nowrap space-x-4 min-w-max flex-1">
                                        ...
                                        <div class="flex-1 min-w-[300px] mb-2 border-r border-gray-300 pr-4">
                                            ...
                                            @if ($item->fligh_locations->shared != 0)
                                                <a
                                                    href="{{ route('filament.admin.resources.fligh-locations.edit', ['tenant' => Auth()->user()->teams()->first()->id, 'record' => $item->fligh_locations->id ?? 0]) }}">
                                                    <p class="text-sm text-gray-700 dark:text-gray-400">
