    ...
    <div class="container mx-auto p-5">
        ...
        <div
            ...
            <div class="flex flex-wrap gap-2 justify-between">
                <button id="tab0"
                    class="tab-button active text-white bg-gray-800 hover:bg-gray-700 px-4 py-2 rounded text-sm sm:text-base w-full sm:w-auto">
                                    ...
                                    <div class="flex flex-nowrap space-x-4 min-w-max flex-1">
                                        <div class="flex-1 min-w-[300px] mb-2 border-r border-gray-300 pr-4">
                                            ...
                                            <a
                                                ...
                                                <p
                                                    class="text-sm text-gray-500 dark:text-gray-150 font-semibold truncate">
                                                    {!! TranslationHelper::translateIfNeeded('cause : ') !!}{{ $item->cause }}</p>
                                            </a>
                                        </div>
                            ...
                            <div
                                ...
                                <div class="flex flex-nowrap space-x-4 min-w-max">
                                    <div class="flex-1 min-w-[300px] mb-2 border-r border-gray-300 pr-4">
                                        ...
                                        @if ($item->shared != 0)
                                            <a
                                                href="{{ route('filament.admin.resources.fligh-locations.view', ['tenant' => Auth()->user()->teams()->first()->id, 'record' => $item->id]) }}">
                                                <p
                                                    class="text-sm text-gray-500 dark:text-gray-150 font-semibold truncate">
                                                    {{ $item->name }}</p>
                                            </a>
                                        ...
                                        @endif
                                        <p class="text-sm text-gray-500 dark:text-gray-150 font-semibold truncate">
                                            {{ $item->latitude }} / {{ $item->longitude }}</p>
                                    </div>

                                    <!-- Column Location-->
                                    <div class="flex-1 min-w-[300px] mb-2 border-r border-gray-300 pr-4">
                                        <p class="text-l text-gray-800 dark:text-gray-200 font-semibold">
                                            {!! TranslationHelper::translateIfNeeded('Address :') !!}</p>
                                        <p class="text-sm text-gray-500 dark:text-gray-150 font-semibold truncate">
                                            {{ $item->address }} {{ $item->city }} {{ $item->country }}</p>
                                        </p>
                                    </div>
