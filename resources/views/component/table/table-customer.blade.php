...
//convert $record to int
    ...
    $customers = App\Models\customer::where('teams_id',$teams)->where('id',$record)->get();
?>
<head>
<style>
    .main-content.active{
    ...
    <div class="mb-4">
        ...
        <div class="flex flex-wrap space-x-4 border border-gray-300 rounded-lg p-2 bg-gray-100 dark:bg-gray-800 max-w-[900px] mx-auto shadow-lg">
            <div class="flex-1 min-w-[180px] border-r border-gray-300 pr-4">
                ...
                <p class="text-sm text-gray-700 dark:text-gray-400">{{$customers->name ?? null}}</p>
            </div>
        
            <div class="flex-1 min-w-[180px] border-r border-gray-300 pr-4 px-4">
                <p class="text-sm text-gray-800 dark:text-gray-200 font-semibold">Conatact</p>
                <p class="text-sm text-gray-700 dark:text-gray-400">{{$customers->phone}}</p>
                <p class="text-sm text-gray-700 dark:text-gray-400">{{$customers->email}}</p>
            </div>
            ...
            <div class="flex-1 min-w-[180px] border-r border-gray-300 pr-2">
                ...
                <p class="text-sm text-gray-700 dark:text-gray-400">{{$customers->address}}</p>
            </div>
            ...
            <button
                ...
                onclick="showContent({{ $customers->id }})">
                More Info
            </button> 
            </div>
        </div>
        ...
        <div id="main-content-{{ $customers->id }}" class="main-content px-2" style="display: none">
            ...
            <div class="flex flex-wrap justify-between py-4 px-6 border-t border-gray-400 bg-gray-300 dark:bg-gray-700  shadow-lg">
                <div class="flex-1 min-w-[180px]">
                    ...
                    <p class="text-sm text-gray-700 dark:text-gray-400">{{$customers->description ?? null}}</p>
                </div>
            </div>
        </div>
    </div>
