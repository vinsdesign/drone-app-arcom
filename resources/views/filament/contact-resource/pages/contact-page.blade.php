        ...
        <div class="container mx-auto p-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg">
                    <h1 class="text-2xl font-bold mb-6 text-center text-gray-900 dark:text-white">Contact Us</h1>
                    <p class="mt-2 text-lg leading-8 text-gray-600 dark:text-white text-center">Leave us feedback or feature requests!</p>
             <!-- Success Notification -->
                    ...
                    <form action="{{ route('sendEmail') }}" method="POST">
                        @csrf
                        <div class="mb-4">
                            <label for="email" class="block text-gray-700 dark:text-gray-300 dark:text-white">Email</label>
                        ...
                        <div class="mb-4">
                            <label for="number" class="block text-gray-700 dark:text-gray-300 dark:text-white">Number</label>
                            <input type="number" id="number" name="number" class="mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm dark:bg-gray-700 dark:text-gray-100" required>
                                ...
                                <!--category-->
                        <div class="mb-4">
                            <label for="category" class="block text-gray-700 dark:text-gray-300 dark:text-white">Category</label>
                            <div class="mt-2.5">
                                <select name="category" id="category" autocomplete="category" class="mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm dark:bg-gray-700 dark:text-gray-100" required>
                                    ...
                                    <option value="Flight Log Importing">Flight Log Importing</option>
                                    <option value="Login - Registration">Login - Registration</option>
                                    <option value="Technical Issue">Technical Issue</option>
                                    <option value="Partnership">Partnership</option>
                                    <option value="Knowledge Base Suggestion">Knowledge Base Suggestion</option>
                        ...
                        <div class="mb-4">
                            <label for="subject" class="block text-gray-700 dark:text-gray-300 dark:text-white">Subject</label>
                        ...
                        <div class="mb-4">
                            <label for="message" class="block text-gray-700 dark:text-gray-300 dark:text-white">Message</label>
                        ...
                        <div class="flex justify-center">
                            <button type="submit" class="bg-indigo-500 text-white px-4 py-2 rounded-md hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-50">Send</button>
                        </div>
                    </form>
                </div>
                <!-- Informational Text -->
                <div class="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg">
                    <h2 class="text-2xl font-bold mb-4 text-gray-900 dark:text-white">Drone Log Book</h2>
                    <p class="text-gray-700 dark:text-gray-300 mb-2 dark:text-white">Thank you for choosing DroneLogBook as your trusted solution for recording drone activities. We are committed to continuously improving our service to meet your needs and expectations. Your feedback is invaluable in helping us grow and deliver the best experience possible. Don’t hesitate to reach out to us through our contact form or email us directly at support. We’re more than happy to listen and respond to any questions or suggestions you may have.

                        We look forward to continuing our collaboration to create the best experience for you.</p>
                    <p class="text-gray-700 dark:text-gray-300 dark:text-white">We invite you to visit us on the following platforms, where you can find more information about our services, as well as various resources that can help you in using DroneLogBook.</p>
