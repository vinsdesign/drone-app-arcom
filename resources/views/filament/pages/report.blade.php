<x-filament-panels::page>
    ...
    <div class="container mx-auto mt-10">
        ...
        <div class="flex justify-center space-x-8">
            <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md w-full max-w-xs">
                <h4 class="text-center text-lg font-semibold mb-4 dark:text-gray-100">Download Flight Report</h4>
            ...
            <div class="bg-white dark:bg-gray-800 p-20 rounded-lg shadow-md w-full max-w-xs">
