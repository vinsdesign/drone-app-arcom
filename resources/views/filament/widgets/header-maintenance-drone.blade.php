    ...
    <div class="filament-stats-overview-widget p-6 border-b bg-white dark:bg-gray-800 rounded-lg shadow">
        ...
        <div class="flex flex-col space-y-6 sm:flex-row sm:space-y-0 justify-between items-center">
            ...
            <div class="flex items-center space-x-4">
                <h1 class="text-2xl font-bold text-gray-800 dark:text-white">{!! GoogleTranslate::trans('Maintenance', session('locale') ?? 'en') !!} <br>
                    Drones</h1><br>
                <span class="text-lg font-medium text-gray-500 dark:text-gray-400 p-2">{{ $maintenance }} {!! GoogleTranslate::trans('Total', session('locale') ?? 'en') !!}</span>
            </div>
