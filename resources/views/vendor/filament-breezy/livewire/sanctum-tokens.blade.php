<x-filament-breezy::grid-section :title="__('filament-breezy::default.profile.sanctum.title')" :description="__('filament-breezy::default.profile.sanctum.description')">
        @if($plainTextToken)
